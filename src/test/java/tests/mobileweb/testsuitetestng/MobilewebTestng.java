...
*
*/
package tests.mobileweb.testsuitetestng;
...
public class MobilewebTestng extends WebDriverTestCase {
    ...
    public void MobilewebTestngTest(Object data1, Object data2, Object password) throws Exception {
                 ...
                 driver.findElement("div.div111_1").waitForEnabled(); 
                 CommonStep.click("div.div111_1"); 
